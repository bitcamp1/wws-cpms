...
d.add(9,0,'My Pictures','example01.html','Pictures I\'ve taken over the years','','','${IMG}/dtree/imgfolder.gif');
d.add(10,9,'The trip to Iceland','example01.html','Pictures of Gullfoss and Geysir');
d.add(11,9,'Mom\'s birthday','example01.html');
d.add(12,0,'Recycle Bin','example01.html','','','${IMG}/dtree/trash.gif');
